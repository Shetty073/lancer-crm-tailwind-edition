...
<main class="px-1 lg:px-4 py-2 mx-2 ls:mx-10 my-5 h-screen">
    ...
    <div class="flex md:justify-between">
        ...
        <div id="{{ $enquiry->id }}" class="mt-5 mr-5 mb-5 md:mt-0 md:mr-0 md:mb-0">
            ...
            @if($enquiry->enquiry_status->id < 4)
                ...
                <input type="hidden" id="deleteEnquiryUrl" value="{{ route('clients.destroy', ['id' => $enquiry->id]) }}">
                <button type="button"
    ...
    <div class="pt-3 pb-2 px-5 rounded shadow-lg bg-indigo-100 mb-10 lg:pb-20">
        <div class="flex justify-between">
            ...
            @if($enquiry->enquiry_status->id < 4) <button
                class="add-followup-btn uppercase rounded bg-green-500 hover:bg-green-600 text-white focus:outline-none px-2 mt-0 mb-4 sm:mt-1 sm:mb-5 block md:inline">
